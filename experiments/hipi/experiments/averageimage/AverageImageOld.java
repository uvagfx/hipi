...
public class AverageImageOld extends Configured implements Tool{
	...
	{	
		...
		Job job = new Job(conf, "averageimage old");
		job.setJarByClass(AverageImageOld.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new AverageImageOld(), args);
		System.exit(res);
	}
}
