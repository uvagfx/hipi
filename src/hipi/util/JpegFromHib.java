...
public class JpegFromHib extends Configured implements Tool {
  ...
  public static class JpegFromHibMapper extends Mapper<HipiImageHeader, ByteImage, BooleanWritable, Text> {
     ...
     */
    @Override
    public void map(HipiImageHeader header, ByteImage image, Context context) 
